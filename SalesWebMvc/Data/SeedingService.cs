...
{
    public class SeedingService//serviço para popular
    {
        //Injeção de dependencia: quando um SeedingService for criado, automaticamente ele vai receber uma instancia do Context
        //1 ---> Registrar a dependecia deste SeedingService com o SalesWebMvcContext
